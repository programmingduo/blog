...
{% comment %}
    ...
    func HeaderPython()
        ...
        call append(line(".")+5, "\# mail: wuduo@baidu.com")
    ...
    func SetTitle()
        ...
        if &filetype == 'sh'
            ...
            call append(line(".")+2, "\# mail: wuduo@baidu.com")
    ...
    " 这些文件 保留tab
    autocmd BufNewFile,BufRead *.html,*.htm,*.css,*.js,*.dat,*.lua set noexpandtab tabstop=4 shiftwidth=4
    ...
    function AddTitle()
        ...
        call append(2," * Author: wangsirui01 - wangsirui01@baidu.com")
